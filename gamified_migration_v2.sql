...
BEGIN
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Start Early = Win Big' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Where Your Money Actually Goes' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Budgeting Without Feeling Broke' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Emergency Fund (Before Investing)' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Lifestyle Inflation / First Salary Trap' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'How to Spot Financial Scams' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Long-Term Investing vs Short-Term Trading' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
  ...
  SELECT id INTO v_lesson_id FROM public.lessons WHERE title = 'Diversification & Portfolio Basics' LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.cards (lesson_id, order_index, type, content, options, correct_option_index, xp_reward, explanation) VALUES
